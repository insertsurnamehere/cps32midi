...
UINT8 rate_convert(INT16 env, UINT8 type, double *new_env){
                    ...
                    switch (data[pos]){
                        case 0xc2:case 0xc3:case 0xc4:case 0xc5:case 0xc6:case 0xc7:case 0xc8:case 0xe0:case 0xe1:{
                            switch (data[pos]){
                                case 0xc5:{
                                    if (data[pos + 1] > 0){
                                        UINT16 vib = data[pos + 1];
                                        vib = vibrato_depth_table[vib];
                                    }
                                    else{
                                        vib_cnt ++;
                                    }
                ...
                //printf("pos %x\t", pos);
                    if (data[pos] < 0x80){ //DELAY
                        ...
                        switch (data[pos]){
                            ...
                            case 0xd4:case 0xd5:case 0xd6:case 0xd7:{ //REPEAT FROM REPEAT OF THE SAME TYPE ( ͡q ͜ʖ ͡°)
